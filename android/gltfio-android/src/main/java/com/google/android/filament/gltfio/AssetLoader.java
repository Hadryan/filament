...
/**
 * Consumes a blob of glTF 2.0 content (either JSON or GLB) and produces an "asset",
...
public class AssetLoader {
     ...
     * @param generator specifies whether materials should be generated on the fly or loaded from a pre-built set
    ...
    /** Frees all memory consumed by the native AssetLoader and its material cache. */
    public void destroy() {
